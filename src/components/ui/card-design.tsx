...
interface CardDesignProps extends Props {
    name: string;
    cardNumber: string;
    expiry: string;
    loading?: boolean;
...
const CardDesign = ({ name, cardNumber, expiry, loading, n=3, ...props }: CardDesignProps) => {
    return !loading ? (
  <div class="creditcard" style={{ width: 'unset', justifyContent: 'flex-start', marginTop: 10, marginBottom: 20, marginLeft: 24 }} {...props}>
    <div class="front is-centered" style={{ position: 'static'}}>
      <div id="ccsingle"></div>
      <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
        x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xmlSpace="preserve">
        <g id="Front">
          <g id="CardBackground">
            <g id="Page-1_1_">
              <g id="amex_1_">
